...
int main()
{
	...
	cout << "Enter a password consisting of exactly 4 "
		 << "letters and 6 digits and lowercase:" << endl;
	...
	else
	{
		cout << "Invalid password. Please enter a password "
			 << "with exactly 4 letters and 6 digits, and all lowercase letters" << endl;
	...
	cout << "There are " << letters << " letters and " << digits << " digits in the password" << endl;
